...
\title{Einweisungsliste Shaper CNC Fräse}
...
\begin{document}
\vspace*{-2em}
\textbf{Diese Liste gilt nur für die Shaper CNC Fräse.}
\medskip

Ich bestätige mit meiner Unterschrift verbindlich, dass ich
\begin{itemize}
 \item die Bedienungsanleitung gelesen und verstanden habe
 \item \textbf{mit der CNC Fräse nur zulässiges Material bearbeiten werde}
