...
\title{Einweisungsliste Nomad 3 CNC Fräse}
...
\begin{document}
\vspace*{-2em}
\textbf{Diese Liste gilt nur für die Nomad 3 CNC Fräse.}
\medskip

Ich bestätige mit meiner Unterschrift verbindlich, dass ich
\begin{itemize}
 \item die Bedienungsanleitung gelesen und verstanden habe
 \item \textbf{die CNC Fräse niemals unbeaufsichtigt laufen lasse und nur zulässiges Material bearbeiten werde}
 \item unter Anleitung erfolgreich ein Werkstück mit der CNC Fräse bearbeitet habe
\end{itemize}
